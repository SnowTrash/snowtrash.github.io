 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gI{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(_I(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function _I(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const _c="@firebase/app",nd="0.10.10";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rs=$I;function Z_(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s=Object.assign({name:mc,automaticDataCollectionEnabled:!1},e),i=s.name;if(typeof i!="string"||!i)throw Jn.create("bad-app-name",{appName:String(i)});if(n||(n=G_()),!n)throw Jn.create("no-options");const r=zo.get(i);if(r){if(qo(n,r.options)&&qo(s,r.config))return r;throw Jn.create("duplicate-app",{appName:i})}const o=new Z0(i);for(const c of yc.values())o.addComponent(c);const l=new qI(n,s,o);return zo.set(i,l),l}function zI(t=mc){const e=zo.get(t);if(!e&&t===mc&&G_())return Z_();if(!e)throw Jn.create("no-app",{appName:t});return e}function bt(t,e,n){var s;let i=(s=VI[t])!==null&&s!==void 0?s:t;n&&(i+=`-${n}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const l=[`Unable to register library "${i}" with version "${e}":`];r&&l.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&l.push("and"),o&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),bn.warn(l.join(" "));return}rn(new zt(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sC(t){rn(new zt("platform-logger",e=>new gI(e),"PRIVATE")),rn(new zt("heartbeat",e=>new eC(e),"PRIVATE")),bt(_c,nd,t),bt(_c,nd,"esm2017"),bt("fire-js","")}sC("");var ad=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yo=new Lr("@firebase/firestore");function wt(t,...e){if(Yo.logLevel<=Ee.DEBUG){const n=e.map(sm);Yo.debug(`Firestore (${Oa}): ${t}`,...n)}}function Iu(t,...e){if(Yo.logLevel<=Ee.ERROR){const n=e.map(sm);Yo.error(`Firestore (${Oa}): ${t}`,...n)}}function sm(t){if(typeof t=="string")return t;try{/**
* @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function im(t="Unexpected state"){const e=`FIRESTORE (${Oa}) INTERNAL ASSERTION FAILED: `+t;throw Iu(e),new Error(e)}function vc(t,e){t||im()}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */new nm([4294967295,4294967295],0);function bl(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qo=new Lr("@firebase/auth");function sR(t,...e){Qo.logLevel<=Ee.WARN&&Qo.warn(`Auth (${rs}): ${t}`,...e)}function So(t,...e){Qo.logLevel<=Ee.ERROR&&Qo.error(`Auth (${rs}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xR(t,e,n=!1){if(gn(t.app))return Promise.reject(bs(t));const s="signIn",i=await Bm(t,s,e),r=await fi._fromIdTokenResponse(t,s,i);return n||await t._updateCurrentUser(r.user),r}function FR(t,e,n,s){return Ti(t).onIdTokenChanged(e,n,s)}const ta="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $m{constructor(e,n){this.storageRetriever=e,this.type=n}_isAvailable(){try{return this.storage?(this.storage.setItem(ta,"1"),this.storage.removeItem(ta),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,n){return this.storage.setItem(e,JSON.stringify(n)),Promise.resolve()}_get(e){const n=this.storage.getItem(e);return Promise.resolve(n?JSON.parse(n):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kl="webStorageSupport";class jA{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=BR,this._completeRedirectFn=uA,this._overrideRedirectResult=aA}async _openPopup(e,n,s,i){var r;In((r=this.eventManagers[e._key()])===null||r===void 0?void 0:r.manager,"_initialize() not called before _openPopup()");const o=await Yd(e,n,s,Cc(),i);return MA(e,o,ju())}async _openRedirect(e,n,s,i){await this._originValidation(e);const r=await Yd(e,n,s,Cc(),i);return WR(r),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:i,promise:r}=this.eventManagers[n];return i?Promise.resolve(i):(In(r,"If manager is not set, promise should be"),r)}const s=this.initAndGetManager(e);return this.eventManagers[n]={promise:s},s.catch(()=>{delete this.eventManagers[n]}),s}async initAndGetManager(e){const n=await AA(e),s=new fA(e);return n.register("authEvent",i=>(le(i==null?void 0:i.authEvent,e,"invalid-auth-event"),{status:s.onEvent(i.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:s},this.iframes[e._key()]=n,s}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(kl,{type:kl},i=>{var r;const o=(r=i==null?void 0:i[0])===null||r===void 0?void 0:r[kl];o!==void 0&&n(!!o),on(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=mA(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return Um()||Om()||xu()}}const BA=jA;var Xd="@firebase/auth",Jd="1.7.8";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pl={},Nl={};function Wu(t){const e=t.toString();return Pl[e]||(Pl[e]=new $k),Pl[e]}function Vk(t,e){const n=t.toString();return Nl[n]||(Nl[n]=e()),Nl[n]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ra extends by{constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!Tu()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new ra}getInitialEvent(e){return z(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class NP extends xa{compare(e,n){const s=e.node.compareTo(n.node);return s===0?Ii(e.name,n.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return pe.MIN}maxPost(){return pe.MAX}makePost(e,n){const s=st(e);return new pe(n,s)}toString(){return".value"}}const OP=new NP;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function la(){return{value:null,children:new Map}}function My(t,e,n){if(he(e))t.value=n,t.children.clear();else if(t.value!==null)t.value=t.value.updateChild(e,n);else{const s=de(e);t.children.has(s)||t.children.set(s,la());const i=t.children.get(s);e=Oe(e),My(i,e,n)}}function Mc(t,e,n){t.value!==null?n(e,t.value):UP(t,(s,i)=>{const r=new Le(e.toString()+"/"+s);Mc(i,r,n)})}function UP(t,e){t.children.forEach((n,s)=>{e(s,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ca{constructor(e,n,s){this.path=e,this.affectedTree=n,this.revert=s,this.type=tn.ACK_USER_WRITE,this.source=Dy()}operationForChild(e){if(he(this.path)){if(this.affectedTree.value!=null)return z(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new Le(e));return new ca(Ie(),n,this.revert)}}else return z(de(this.path)===e,"operationForChild called for unrelated child."),new ca(Oe(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Op;function yN(t){z(!Op,"__referenceConstructor has already been defined"),Op=t}class Lp{constructor(e){this.listenProvider_=e,this.syncPointTree_=new ke(null),this.pendingWriteTree_=iN(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function vN(t,e,n,s,i){return qP(t.pendingWriteTree_,e,n,s,i),i?Ua(t,new As(Dy(),e,n)):[]}function Ks(t,e,n=!1){const s=zP(t.pendingWriteTree_,e);if(YP(t.pendingWriteTree_,e)){let r=new ke(null);return s.snap!=null?r=r.set(Ie(),!0):Ft(s.children,o=>{r=r.set(new Le(o),!0)}),Ua(t,new ca(s.path,r,n))}else return[]}function Fa(t,e,n){return Ua(t,new As(xy(),e,n))}function EN(t,e,n){const s=ke.fromObject(n);return Ua(t,new Sr(xy(),e,s))}function wN(t,e,n,s){const i=Qy(t,s);if(i!=null){const r=Zy(i),o=r.path,l=r.queryId,c=Dt(o,e),u=new As(Fy(l),c,n);return ev(t,o,u)}else return[]}function TN(t,e,n,s){const i=Qy(t,s);if(i){const r=Zy(i),o=r.path,l=r.queryId,c=Dt(o,e),u=ke.fromObject(n),f=new Sr(Fy(l),c,u);return ev(t,o,f)}else return[]}function Yy(t,e,n){const i=t.pendingWriteTree_,r=t.syncPointTree_.findOnPath(e,(o,l)=>{const c=Dt(o,e),u=Zu(l,c);if(u)return u});return Vy(i,e,r,n,!0)}function Ua(t,e){return Xy(e,t.syncPointTree_,null,By(t.pendingWriteTree_,Ie()))}function Xy(t,e,n,s){if(he(t.path))return Jy(t,e,n,s);{const i=e.get(Ie());n==null&&i!=null&&(n=Zu(i,Ie()));let r=[];const o=de(t.path),l=t.operationForChild(o),c=e.children.get(o);if(c&&l){const u=n?n.getImmediateChild(o):null,f=Ky(s,o);r=r.concat(Xy(l,c,u,f))}return i&&(r=r.concat(Qu(i,t,s,n))),r}}function Jy(t,e,n,s){const i=e.get(Ie());n==null&&i!=null&&(n=Zu(i,Ie()));let r=[];return e.children.inorderTraversal((o,l)=>{const c=n?n.getImmediateChild(o):null,u=Ky(s,o),f=t.operationForChild(o);f&&(r=r.concat(Jy(f,l,c,u)))}),i&&(r=r.concat(Qu(i,t,s,n))),r}function Qy(t,e){return t.tagToQueryMap.get(e)}function Zy(t){const e=t.indexOf("$");return z(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new Le(t.substr(0,e))}}function ev(t,e,n){const s=t.syncPointTree_.get(e);z(s,"Missing sync point for query tag that we're tracking");const i=By(t.pendingWriteTree_,e);return Qu(s,n,i,null)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jN="repo_interrupt",BN=25;class $N{constructor(e,n,s,i){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=s,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new xN,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=la(),this.transactionQueueTree_=new sh,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function VN(t,e,n){if(t.stats_=Wu(t.repoInfo_),t.forceRestClient_||Fk())t.server_=new aa(t.repoInfo_,(s,i,r,o)=>{Dp(t,s,i,r,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>xp(t,!0),0);else{if(typeof n<"u"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{Ze(n)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}t.persistentConnection_=new wn(t.repoInfo_,e,(s,i,r,o)=>{Dp(t,s,i,r,o)},s=>{xp(t,s)},s=>{KN(t,s)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(s=>{t.server_.refreshAuthToken(s)}),t.appCheckProvider_.addTokenChangeListener(s=>{t.server_.refreshAppCheckToken(s.token)}),t.statsReporter_=Vk(t.repoInfo_,()=>new $P(t.stats_,t.server_)),t.infoData_=new FP,t.infoSyncTree_=new Lp({startListening:(s,i,r,o)=>{let l=[];const c=t.infoData_.getNode(s._path);return c.isEmpty()||(l=Fa(t.infoSyncTree_,s._path,c),setTimeout(()=>{o("ok")},0)),l},stopListening:()=>{}}),rh(t,"connected",!1),t.serverSyncTree_=new Lp({startListening:(s,i,r,o)=>(t.server_.listen(s,r,i,(l,c)=>{const u=o(l,c);Ls(t.eventQueue_,s._path,u)}),[]),stopListening:(s,i)=>{t.server_.unlisten(s,i)}})}function WN(t){const n=t.infoData_.getNode(new Le(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function ov(t){return bN({timestamp:WN(t)})}function Dp(t,e,n,s,i){t.dataUpdateCount++;const r=new Le(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(i)if(s){const c=Go(n,u=>st(u));o=TN(t.serverSyncTree_,r,c,i)}else{const c=st(n);o=wN(t.serverSyncTree_,r,c,i)}else if(s){const c=Go(n,u=>st(u));o=EN(t.serverSyncTree_,r,c)}else{const c=st(n);o=Fa(t.serverSyncTree_,r,c)}let l=r;o.length>0&&(l=ah(t,r)),Ls(t.eventQueue_,l,o)}function xp(t,e){rh(t,"connected",e),e===!1&&qN(t)}function KN(t,e){Ft(e,(n,s)=>{rh(t,n,s)})}function rh(t,e,n){const s=new Le("/.info/"+e),i=st(n);t.infoData_.updateSnapshot(s,i);const r=Fa(t.infoSyncTree_,s,i);Ls(t.eventQueue_,s,r)}function GN(t){return t.nextWriteId_++}function qN(t){av(t,"onDisconnectEvents");const e=ov(t),n=la();Mc(t.onDisconnect_,Ie(),(i,r)=>{const o=SN(i,r,t.serverSyncTree_,e);My(n,i,o)});let s=[];Mc(n,Ie(),(i,r)=>{s=s.concat(Fa(t.serverSyncTree_,i,r));const o=JN(t,i);ah(t,o)}),t.onDisconnect_=la(),Ls(t.eventQueue_,Ie(),s)}function zN(t){t.persistentConnection_&&t.persistentConnection_.interrupt(jN)}function av(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),nt(n,...e)}function lv(t,e,n){return Yy(t.serverSyncTree_,e,n)||we.EMPTY_NODE}function oh(t,e=t.transactionQueueTree_){if(e||ja(t,e),Ci(e)){const n=uv(t,e);z(n.length>0,"Sending zero length transaction queue"),n.every(i=>i.status===0)&&YN(t,Br(e),n)}else nv(e)&&Ha(e,n=>{oh(t,n)})}function YN(t,e,n){const s=n.map(u=>u.currentWriteId),i=lv(t,e,s);let r=i;const o=i.hash();for(let u=0;u<n.length;u++){const f=n[u];z(f.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),f.status=1,f.retryCount++;const d=Dt(e,f.path);r=r.updateChild(d,f.currentOutputSnapshotRaw)}const l=r.val(!0),c=e;t.server_.put(c.toString(),l,u=>{av(t,"transaction put response",{path:c.toString(),status:u});let f=[];if(u==="ok"){const d=[];for(let g=0;g<n.length;g++)n[g].status=2,f=f.concat(Ks(t.serverSyncTree_,n[g].currentWriteId)),n[g].onComplete&&d.push(()=>n[g].onComplete(null,!0,n[g].currentOutputSnapshotResolved)),n[g].unwatcher();ja(t,ih(t.transactionQueueTree_,e)),oh(t,t.transactionQueueTree_),Ls(t.eventQueue_,e,f);for(let g=0;g<d.length;g++)Hr(d[g])}else{if(u==="datastale")for(let d=0;d<n.length;d++)n[d].status===3?n[d].status=4:n[d].status=0;else{It("transaction at "+c.toString()+" failed: "+u);for(let d=0;d<n.length;d++)n[d].status=4,n[d].abortReason=u}ah(t,e)}},o)}function ah(t,e){const n=cv(t,e),s=Br(n),i=uv(t,n);return XN(t,i,s),s}function XN(t,e,n){if(e.length===0)return;const s=[];let i=[];const o=e.filter(l=>l.status===0).map(l=>l.currentWriteId);for(let l=0;l<e.length;l++){const c=e[l],u=Dt(n,c.path);let f=!1,d;if(z(u!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),c.status===4)f=!0,d=c.abortReason,i=i.concat(Ks(t.serverSyncTree_,c.currentWriteId,!0));else if(c.status===0)if(c.retryCount>=BN)f=!0,d="maxretry",i=i.concat(Ks(t.serverSyncTree_,c.currentWriteId,!0));else{const g=lv(t,c.path,o);c.currentInputSnapshot=g;const T=e[l].update(g.val());if(T!==void 0){rv("transaction failed: Data returned ",T,c.path);let C=st(T);typeof T=="object"&&T!=null&&Sn(T,".priority")||(C=C.updatePriority(g.getPriority()));const F=c.currentWriteId,B=ov(t),k=RN(C,g,B);c.currentOutputSnapshotRaw=C,c.currentOutputSnapshotResolved=k,c.currentWriteId=GN(t),o.splice(o.indexOf(F),1),i=i.concat(vN(t.serverSyncTree_,c.path,k,c.currentWriteId,c.applyLocally)),i=i.concat(Ks(t.serverSyncTree_,F,!0))}else f=!0,d="nodata",i=i.concat(Ks(t.serverSyncTree_,c.currentWriteId,!0))}Ls(t.eventQueue_,n,i),i=[],f&&(e[l].status=2,function(g){setTimeout(g,Math.floor(0))}(e[l].unwatcher),e[l].onComplete&&(d==="nodata"?s.push(()=>e[l].onComplete(null,!1,e[l].currentInputSnapshot)):s.push(()=>e[l].onComplete(new Error(d),!1,null))))}ja(t,t.transactionQueueTree_);for(let l=0;l<s.length;l++)Hr(s[l]);oh(t,t.transactionQueueTree_)}function cv(t,e){let n,s=t.transactionQueueTree_;for(n=de(e);n!==null&&Ci(s)===void 0;)s=ih(s,n),e=Oe(e),n=de(e);return s}function uv(t,e){const n=[];return hv(t,e,n),n.sort((s,i)=>s.order-i.order),n}function hv(t,e,n){const s=Ci(e);if(s)for(let i=0;i<s.length;i++)n.push(s[i]);Ha(e,i=>{hv(t,i,n)})}function ja(t,e){const n=Ci(e);if(n){let s=0;for(let i=0;i<n.length;i++)n[i].status!==2&&(n[s]=n[i],s++);n.length=s,tv(e,n.length>0?n:void 0)}Ha(e,s=>{ja(t,s)})}function JN(t,e){const n=Br(cv(t,e)),s=ih(t.transactionQueueTree_,e);return kN(s,i=>{xl(t,i)}),xl(t,s),sv(s,i=>{xl(t,i)}),n}function xl(t,e){const n=Ci(e);if(n){const s=[];let i=[],r=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(z(r===o-1,"All SENT items should be at beginning of queue."),r=o,n[o].status=3,n[o].abortReason="set"):(z(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),i=i.concat(Ks(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&s.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?tv(e,void 0):n.length=r+1,Ls(t.eventQueue_,Br(e),i);for(let o=0;o<s.length;o++)Hr(s[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function EO(t){return t!==void 0}function Hp(t,e,n,s){if(s<e)throw Up(`Invalid value for '${t}'. Expected ${e} or greater.`);if(s>n)throw Up(`Invalid value for '${t}'. Expected ${n} or less.`)}function wO(t){const e=encodeURIComponent;let n="?";for(const s in t)if(t.hasOwnProperty(s)){const i=e(s)+"="+e(t[s]);n=n+i+"&"}return n=n.slice(0,-1),n}var fa;(function(t){t[t.NO_ERROR=0]="NO_ERROR",t[t.NETWORK_ERROR=1]="NETWORK_ERROR",t[t.ABORT=2]="ABORT"})(fa||(fa={}));/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const OO="storage";function LO(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),s=t.getProvider("auth-internal"),i=t.getProvider("app-check-internal");return new NO(n,s,i,e,rs)}function MO(){rn(new zt(OO,LO,"PUBLIC").setMultipleInstances(!0)),bt(Bp,$p,""),bt(Bp,$p,"esm2017")}MO();const Ul=new WeakMap;function DO(t,e){return Ul.has(e)||Ul.set(e,t||{f:{},r:{},s:{},u:{}}),Ul.get(e)}const ch=Symbol("VueFireAuth");function xO({dependencies:t,initialUser:e}){return(n,s)=>{const[i,r]=FO(n,s,e,t);Tk(i,r)}}function FO(t,e,n,s,i=NR(t,s)){const r=vk(t,e).run(()=>Kt(n));return Ek.set(t,r),e.provide(ch,i),[r,i]}function R1(t){return yk?Xe(ch):null}function UO(t,{firebaseApp:e,modules:n=[]}){t.provide(ey,e);for(const s of n)s(e,t)}const HO=Ct(t=>{const e=t.$firebaseApp;return xO({initialUser:t.payload.vuefireUser,dependencies:{errorMap:bm,persistence:[ZR,jR],popupRedirectResolver:BA}})(e,t.vueApp),{provide:{firebaseAuth:t.vueApp.runWithContext(()=>Xe(ch))}}}),jO=Ct(t=>{var n;const e=t.$firebaseApp;t.vueApp.use(UO,{firebaseApp:e}),(n=t.payload)!=null&&n.vuefire&&DO(t.payload.vuefire,e)}),BO=Ct({name:"nuxt:chunk-reload",setup(t){const e=ln(),n=Sa(),s=new Set;e.beforeEach(()=>{s.clear()}),t.hook("app:chunkError",({error:r})=>{s.add(r)});function i(r){const l="href"in r&&r.href[0]==="#"?n.app.baseURL+r.href:_u(n.app.baseURL,r.fullPath);XS({path:l,persistState:!0})}t.hook("app:manifest:update",()=>{e.beforeResolve(i)}),e.onError((r,o)=>{s.has(r)&&i(o)})}}),$O=[bC,IC,SC,WS,KS,GS,JS,QS,ZS,nR,HO,jO,BO],VO=is({props:{vnode:{type:Object,required:!0},route:{type:Object,required:!0},vnodeRef:Object,renderKey:String,trackRootNodes:Boolean},setup(t){const e=t.renderKey,n=t.route,s={};for(const i in t.route)Object.defineProperty(s,i,{get:()=>e===t.renderKey?t.route[i]:n[i]});return Ts(Or,kr(s)),()=>Tt(t.vnode,{ref:t.vnodeRef})}}),WO=is({name:"NuxtPage",inheritAttrs:!1,props:{name:{type:String},transition:{type:[Boolean,Object],default:void 0},keepalive:{type:[Boolean,Object],default:void 0},route:{type:Object},pageKey:{type:[Function,String],default:null}},setup(t,{attrs:e,expose:n}){const s=Ue(),i=Kt(),r=Xe(Or,null);let o;n({pageRef:i});const l=Xe(A_,null);let c;const u=s.deferHydration();if(s.isHydrating){const f=s.hooks.hookOnce("app:error",u);ln().beforeEach(f)}return t.pageKey&&Js(()=>t.pageKey,(f,d)=>{f!==d&&s.callHook("page:loading:start")}),()=>Tt(ym,{name:t.name,route:t.route,...e},{default:f=>{const d=GO(r,f.route,f.Component),g=r&&r.matched.length===f.route.matched.length;if(!f.Component){if(c&&!g)return c;u();return}if(c&&l&&!l.isCurrent(f.route))return c;if(d&&r&&(!l||l!=null&&l.isCurrent(r)))return g?c:null;const T=bc(f,t.pageKey);!s.isHydrating&&!qO(r,f.route,f.Component)&&o===T&&s.callHook("page:loading:end"),o=T;const C=!!(t.transition??f.route.meta.pageTransition??fc),O=C&&KO([t.transition,f.route.meta.pageTransition,fc,{onAfterLeave:()=>{s.callHook("page:transition:finish",f.Component)}}].filter(Boolean)),F=t.keepalive??f.route.meta.keepalive??E0;return c=vm(Ia,C&&O,NS(F,Tt(ou,{suspensible:!0,onPending:()=>s.callHook("page:start",f.Component),onResolve:()=>{mi(()=>s.callHook("page:finish",f.Component).then(()=>s.callHook("page:loading:end")).finally(u))}},{default:()=>{const B=Tt(VO,{key:T||void 0,vnode:f.Component,route:f.route,renderKey:T||void 0,trackRootNodes:C,vnodeRef:i});return F&&(B.type.name=f.Component.type.name||f.Component.type.__name||"RouteProvider"),B}}))).default(),c}})}});function KO(t){const e=t.map(n=>({...n,onAfterLeave:n.onAfterLeave?ku(n.onAfterLeave):void 0}));return S_(...e)}function GO(t,e,n){if(!t)return!1;const s=e.matched.findIndex(i=>{var r;return((r=i.components)==null?void 0:r.default)===(n==null?void 0:n.type)});return!s||s===-1?!1:e.matched.slice(0,s).some((i,r)=>{var o,l,c;return((o=i.components)==null?void 0:o.default)!==((c=(l=t.matched[r])==null?void 0:l.components)==null?void 0:c.default)})||n&&bc({route:e,Component:n})!==bc({route:t,Component:n})}function qO(t,e,n){return t?e.matched.findIndex(i=>{var r;return((r=i.components)==null?void 0:r.default)===(n==null?void 0:n.type)})<e.matched.length-1:!1}const zO=is({name:"LayoutLoader",inheritAttrs:!1,props:{name:String,layoutProps:Object},async setup(t,e){const n=await qn[t.name]().then(s=>s.default||s);return()=>Tt(n,t.layoutProps,e.slots)}}),YO=is({name:"NuxtLayout",inheritAttrs:!1,props:{name:{type:[String,Boolean,Object],default:null},fallback:{type:[String,Object],default:null}},setup(t,e){const n=Ue(),s=Xe(Or),i=s===vu()?kS():s,r=Ot(()=>{let c=Pe(t.name)??i.meta.layout??"default";return c&&!(c in qn)&&t.fallback&&(c=Pe(t.fallback)),c}),o=Kt();e.expose({layoutRef:o});const l=n.deferHydration();if(n.isHydrating){const c=n.hooks.hookOnce("app:error",l);ln().beforeEach(c)}return()=>{const c=r.value&&r.value in qn,u=i.meta.layoutTransition??v0;return vm(Ia,c&&u,{default:()=>Tt(ou,{suspensible:!0,onResolve:()=>{mi(l)}},{default:()=>Tt(XO,{layoutProps:s_(e.attrs,{ref:o}),key:r.value||void 0,name:r.value,shouldProvide:!t.name,hasTransition:!!u},e.slots)})}).default()}}}),XO=is({name:"NuxtLayoutProvider",inheritAttrs:!1,props:{name:{type:[String,Boolean]},layoutProps:{type:Object},hasTransition:{type:Boolean},shouldProvide:{type:Boolean}},setup(t,e){const n=t.name;return t.shouldProvide&&Ts(A_,{isCurrent:s=>n===(s.meta.layout??"default")}),()=>{var s,i;return!n||typeof n=="string"&&!(n in qn)?(i=(s=e.slots).default)==null?void 0:i.call(s):Tt(zO,{key:n,layoutProps:t.layoutProps,name:n},e.slots)}}}),JO=(t,e)=>{const n=t.__vccOpts||t;for(const[s,i]of e)n[s]=i;return n},QO={};function ZO(t,e){const n=WO,s=YO;return en(),pn(s,null,{default:iu(()=>[xe(n)]),_:1})}const e1=JO(QO,[["render",ZO]]),t1={__name:"nuxt-error-page",props:{error:Object},setup(t){const n=t.error;n.stack&&n.stack.split(`
`).splice(1).map(d=>({text:d.replace("webpack:/","").replace(".vue",".js").trim(),internal:d.includes("node_modules")&&!d.includes(".cache")||d.includes("internal")||d.includes("new Promise")})).map(d=>`<span class="stack${d.internal?" internal":""}">${d.text}</span>`).join(`
`);const s=Number(n.statusCode||500),i=s===404,r=n.statusMessage??(i?"Page Not Found":"Internal Server Error"),o=n.message||n.toString(),l=void 0,f=i?df(()=>Ic(()=>import("./XMl0FEJA.js"),__vite__mapDeps([2,3,4]),import.meta.url).then(d=>d.default||d)):df(()=>Ic(()=>import("./Cyltg8fb.js"),__vite__mapDeps([5,3,6]),import.meta.url).then(d=>d.default||d));return(d,g)=>(en(),pn(Pe(f),Xv(t_({statusCode:Pe(s),statusMessage:Pe(r),description:Pe(o),stack:Pe(l)})),null,16))}},Vp={__name:"nuxt-root",setup(t){const e=()=>null,n=Ue(),s=n.deferHydration();if(n.isHydrating){const l=n.hooks.hookOnce("app:error",s);ln().beforeEach(l)}const i=!1;Ts(Or,vu()),n.hooks.callHookWith(l=>l.map(c=>c()),"vue:setup");const r=Ra();Lg((l,c,u)=>{if(n.hooks.callHook("vue:error",l,c,u).catch(f=>console.error("[nuxt] Error in `vue:error` hook",f)),kb(l)&&(l.fatal||l.unhandled))return n.runWithContext(()=>Vs(l)),!1});const o=!1;return(l,c)=>(en(),pn(ou,{onResolve:Pe(s)},{default:iu(()=>[Pe(r)?(en(),pn(Pe(t1),{key:0,error:Pe(r)},null,8,["error"])):Pe(o)?(en(),pn(Pe(e),{key:1,context:Pe(o)},null,8,["context"])):Pe(i)?(en(),pn(FE(Pe(i)),{key:2})):(en(),pn(Pe(e1),{key:3}))]),_:1},8,["onResolve"]))}};let Wp;{let t;Wp=async function(){var o,l;if(t)return t;const s=!!((o=window.__NUXT__)!=null&&o.serverRendered||((l=document.getElementById("__NUXT_DATA__"))==null?void 0:l.dataset.ssr)==="true")?aT(Vp):oT(Vp),i=db({vueApp:s});async function r(c){await i.callHook("app:error",c),i.payload.error=i.payload.error||Aa(c)}s.config.errorHandler=r;try{await gb(i,$O)}catch(c){r(c)}try{await i.hooks.callHook("app:created",s),await i.hooks.callHook("app:beforeMount",s),s.mount(w0),await i.hooks.callHook("app:mounted",s),await mi()}catch(c){r(c)}return s.config.errorHandler===r&&(s.config.errorHandler=void 0),s},t=Wp().catch(e=>{throw console.error("Error while mounting app:",e),e})}export{d1 as $,iu as A,n_ as B,o1 as C,a1 as D,T1 as E,c1 as F,cc as G,Js as H,ZE as I,QE as J,yi as K,Tn as L,I1 as M,m1 as N,eE as O,s1 as P,mi as Q,Pe as R,hg as S,at as T,r1 as U,i1 as V,dr as W,Tw as X,ss as Y,Xe as Z,JO as _,wm as a,ma as a0,_a as a1,Ts as a2,Og as a3,gt as a4,f1 as a5,p1 as a6,y1 as a7,kr as a8,E1 as a9,g1 as aa,pn as ab,Ji as ac,h1 as ad,u1 as ae,v1 as af,Ia as ag,R1 as ah,ou as ai,S1 as aj,Wn as ak,Dd as b,Ot as c,is as d,uu as e,C1 as f,Tt as g,Ns as h,l1 as i,_u as j,IT as k,Sa as l,Ue as m,b1 as n,cu as o,Ca as p,w1 as q,Kt as r,gu as s,en as t,ln as u,_1 as v,nc as w,e_ as x,n1 as y,xe as z};
